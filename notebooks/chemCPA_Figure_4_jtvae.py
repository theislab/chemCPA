...
# * Supplement Figures 13 for JT-VAE
# ___
# # Imports
...
# %% [markdown]
# ## Supplement Figure 13 for JT-VAE
# **Parameters**
# * DEGs
# * Extended gene set
...
if SAVEFIG:
    if BLACK:
        plt.savefig(
            FIGURE_DIR / "all_drug_examples_jtvae_extended_degs_black.png", format="png"
        )
    else:
        plt.savefig(
            FIGURE_DIR / "all_drug_examples_jtvae_extended_degs.png", format="png"
        )
...
if SAVEFIG:
    if BLACK:
        plt.savefig(
            FIGURE_DIR / "drug_examples_jtvae_extended_degs_black.png", format="png"
        )  # BLACK
    else:
        plt.savefig(FIGURE_DIR / "drug_examples_jtvae_extended_degs.png", format="png")
