...
if SAVEFIG:
    if BLACK:
        plt.savefig(
            FIGURE_DIR / "all_drug_examples_grover_shared_degs_black.png", format="png"
        )
    else:
        plt.savefig(
            FIGURE_DIR / "all_drug_examples_grover_shared_degs.png", format="png"
        )
...
if SAVEFIG:
    if BLACK:
        plt.savefig(
            FIGURE_DIR / "drug_examples_grover_shared_degs_black.png", format="png"
        )  # BLACK
    else:
