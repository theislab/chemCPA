...
# * Trained models
# * GROVER:
#      * fine-tuned:      `'0f4a3b11e1fbe3da58125f39ff6fb035'`
#      * non-pretrained: `'b372147c80cf9ad4bd10d16bc56b7534'`
#
...
# GROVER, batch 10
model_hash_pretrained = "0f4a3b11e1fbe3da58125f39ff6fb035"  # Fine-tuned
model_hash_scratch = "b372147c80cf9ad4bd10d16bc56b7534"  # Non-pretrained
...
if SAVEFIG:
    if BLACK:
        plt.savefig(
            FIGURE_DIR / "GROVER_extended_gene_set_black.pdf", format="pdf"
        )  # BLACK:
    else:
        plt.savefig(FIGURE_DIR / "GROVER_extended_gene_set.pdf", format="pdf")  # WHITE
...
if SAVEFIG:
    if BLACK:
        plt.savefig(
            FIGURE_DIR / "all_drug_examples_grover_extended_degs_black.png",
            format="png",
        )
    else:
        plt.savefig(
            FIGURE_DIR / "all_drug_examples_grover_extended_degs.png", format="png"
        )
...
if SAVEFIG:
    if BLACK:
        plt.savefig(
            FIGURE_DIR / "drug_examples_grover_extended_degs_black.png", format="png"
        )  # BLACK
    else:
