...
model_hash_pretrained = "f9e328d21bff64c5541f81ae1303c279"  # Fine-tuned
model_hash_scratch = "d273bf129f3a866a4d02f8925cf5cc8d"  # Non-pretrained
...
if SAVEFIG:
    if BLACK:
        plt.savefig(
            FIGURE_DIR / "JTVAE_shared_gene_set_black.eps", format="eps"
        )  # BLACK:
    else:
        plt.savefig(FIGURE_DIR / "JTVAE_shared_gene_set.eps", format="eps")  # WHITE
...
if SAVEFIG:
    if BLACK:
        plt.savefig(
            FIGURE_DIR / "all_drug_examples_jtvae_shared_degs_black.png", format="png"
        )
    else:
        plt.savefig(
            FIGURE_DIR / "all_drug_examples_jtvae_shared_degs.png", format="png"
        )
...
if SAVEFIG:
    if BLACK:
        plt.savefig(
            FIGURE_DIR / "drug_examples_jtvae_shared_degs_black.png", format="png"
        )  # BLACK
    else:
