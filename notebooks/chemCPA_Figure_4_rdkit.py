...
if SAVEFIG:
    if BLACK:
        plt.savefig(
            FIGURE_DIR / "all_drug_examples_rdkit_extended_degs_black.png", format="png"
        )
    else:
        plt.savefig(
            FIGURE_DIR / "all_drug_examples_rdkit_extended_degs.png", format="png"
        )
...
if SAVEFIG:
    if BLACK:
        plt.savefig(
            FIGURE_DIR / "drug_examples_rdkit_extended_degs_black.png", format="png"
        )  # BLACK
    else:
...
if SAVEFIG:
    if BLACK:
        plt.savefig(
            FIGURE_DIR / "all_drug_examples_rdkit_extended_all_genes_black.png",
            format="png",
        )
    else:
        plt.savefig(
            FIGURE_DIR / "all_drug_examples_rdkit_extended_all_genes.png", format="png"
        )
...
if SAVEFIG:
    if BLACK:
        plt.savefig(
            FIGURE_DIR / "drug_examples_rdkit_extended_all_genes_black.png",
            format="png",
        )  # BLACK
    else:
        plt.savefig(
            FIGURE_DIR / "drug_examples_rdkit_extended_all_genes.png", format="png"
        )
